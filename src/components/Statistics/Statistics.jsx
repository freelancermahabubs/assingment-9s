...
const Statistics = () => {
  ...
  { id: 3, name: "Third Assignment", marks: 60},
  { id: 4, name: "Fourth Assignment", marks: 60},
  { id: 5, name: "Fifth Assignment", marks: 54},
  { id: 6, name: "Sixth Assignment", marks: 58},
  { id: 7, name: "Seventh Assignment", marks: 60},
  { id: 8, name: "Eighth Assignment", marks: 60},
...
<div className='bg-gray-100 rounded -mt-24'>
 ...
 <img src={Vector} alt="" />
 <h2 className='text-center mt-12 pt-12 font-bold text-3xl mb-5'>Assignment Marks Statistics</h2>
<img src={Vector1} alt="" />
 </div>
  </div>
