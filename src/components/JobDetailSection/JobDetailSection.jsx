  ...
  return (
    <div className='grid lg:grid-cols-4'>
      <div className='pt-8 col-span-3 px-4'>
       ...
       <div className='mb-8'>
       <h1 className='text-xl'><span className='text-2xl font-bold'>Job Description:</span> {job_description}</h1>
      </div>

    <div  className='mb-8'>
    <h1 className='text-xl'><span className='text-2xl font-bold'>Job REsponsibility:</span> {job_responsibility}</h1>
    </div>

    <div  className='mb-8'>
    <h1 className='text-xl'><span className='text-2xl font-bold'>Educational Requirements:</span> {educational_requirements}</h1>
    </div>

    <div  className='mb-8'>
    <h1 className='text-xl'><span className='text-2xl font-bold'>Experiences:</span> {experiences}</h1>
    </div>
      </div>
